...
function () {
  function Sequencer() {
    ...
    // this.mSeq = JZZ().or('Cannot start MIDI engine!')
    //     .openMidiOut(['Microsoft GS Wavetable Synth', 'Apple DLS Synth', 0]).or('Cannot open MIDI out!');
  ...
  _createClass(Sequencer, [{
    ...
    value: function prepare(pForm) {
      ...
      switch (pForm.mode) {
        ...
        default:
          break;
      } // console.log(this.fixChordName(this.mScale.degree(pForm.progression[0]).asString+pForm.chords[0]));
      // console.log(this.fixChordName(this.mScale.degree(pForm.progression[1]).asString+pForm.chords[1]));
      // console.log(this.fixChordName(this.mScale.degree(pForm.progression[2]).asString+pForm.chords[2]));
      // console.log(this.fixChordName(this.mScale.degree(pForm.progression[3]).asString+pForm.chords[3]));   
